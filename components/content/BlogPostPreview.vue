...
<template>
  <NuxtLink
    ...
    class="blog-post-preview bg-white dark:bg-neutral-950 shadow-lg hover:shadow-xl dark:shadow-neutral-800 dark:hover:shadow-neutral-700 rounded-md overflow-hidden my-10 mb-12 mx-8 sm:max-w-screen-sm sm:mx-32 block transition-all duration-300 hover:-translate-y-2"
  >
    <NuxtImg
      :src="post.cover"
      :alt="post.coverAlt"
